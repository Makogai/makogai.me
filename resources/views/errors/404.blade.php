    ...
    <style>
        ...
        body {
            ...
            background:
                ...
                radial-gradient(circle at 80% 15%, rgba(34,211,238,0.14), transparent 34%),
...
<body>
    <main class="card">
        ...
        <h1>That page is in another timeline.</h1>
        <p>The route does not exist or the content moved. Jump back to the homepage.</p>
